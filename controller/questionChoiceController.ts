...
const createQuestionChoice = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    ...
    if (question && user) {
        ...
        res.status(201).json({ message: 'Question choice created', questionChoice: newQuestionChoice });
    } else {
...
const updateQuestionChoice = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    ...
    res.status(200).json({ message: 'Question choice updated successfully', questionChoice: updatedQuestionChoice });
